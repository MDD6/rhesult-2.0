...
function buildStats(candidatos: Candidato[]): DashboardStats {
  ...
  return { leadsNaoAtribuidos, emAvaliacao, retornosPendentes };
}
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setVagas(parseJsonArray<Vaga>(vagasPayload));
        setCandidatos(parseJsonArray<Candidato>(candidatosPayload));
      } catch (err) {
